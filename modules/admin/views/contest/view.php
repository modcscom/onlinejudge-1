...
<div class="contest-view">
    ...
    <p>
        ...
        <?= Html::a(Yii::t('app', 'Clarification'), ['clarify', 'id' => $model->id], ['class' => 'btn btn-info', 'target' => '_blank']) ?>
        <?= Html::a(Yii::t('app', 'Submissions'), ['status', 'id' => $model->id], ['class' => 'btn btn-primary', 'target' => '_blank']) ?>
        <?= Html::a(Yii::t('app', 'Score'), ['rated', 'id' => $model->id], ['class' => 'btn btn-success']) ?>
        <?= Html::a(Yii::t('app', 'Contestant'), ['register', 'id' => $model->id], ['class' => 'btn btn-warning']) ?>

        <?= Html::a(Yii::t('app', 'Editorial'), ['editorial', 'id' => $model->id], ['class' => 'btn btn-info']) ?>
        <?= Html::a(Yii::t('app', 'Print Problem'), ['print', 'id' => $model->id], ['class' => 'btn btn-primary', 'target' => '_blank']) ?>
        <?= Html::a(Yii::t('app', 'Print Rank'), ['rank', 'id' => $model->id], ['class' => 'btn btn-success', 'target' => '_blank']) ?>
        <?= Html::a('Accessible by all users', ['/contest/standing2', 'id' => $model->id], ['class' => 'btn btn-warning', 'target' => '_blank']) ?>
    ...
    <h3>
        ...
        <medium><?= Html::a(Yii::t('app', 'Edit'), ['update', 'id' => $model->id], ['class' => 'btn btn-primary']) ?></small>
    </h3>
    <?= DetailView::widget([
        'model' => $model,
        'attributes' => [
    ...
    <?php Modal::begin([
        'header' => '<h3>'.Yii::t('app','Source Problem').'</h3>',
        'toggleButton' => ['label' => 'Set problems source', 'class' => 'btn btn-success'],
    ]); ?>
    ...
    <?php Modal::begin([
        'header' => '<h3>'.Yii::t('app','Status Display').'</h3>',
        'toggleButton' => ['label' => 'Set status display', 'class' => 'btn btn-success'],
    ]); ?>
