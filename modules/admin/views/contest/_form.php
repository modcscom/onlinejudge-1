...
<div class="contest-form">
    ...
    <?= $form->field($model, 'start_time')->textInput(['type' => 'datetime']) ?>

    <?= $form->field($model, 'end_time')->textInput(['type' => 'datetime']) ?>

    <?= $form->field($model, 'lock_board_time')->textInput(['type' => 'datetime']) ?>
