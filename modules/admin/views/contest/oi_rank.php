    ...
    <div class="container">
        ...
        <table class="table table-bordered table-rank">
            ...
            <tr>
                ...
                <th width="80px">Re-judge score</th>
                <th>
                    Total time
                    <span data-toggle="tooltip" data-placement="top" title="Chỉ tính tổng thời gian cần thiết để vượt qua tất cả các câu hỏi (đơn vị: phút)">
