...
<div class="wrap">
    <div class="container">
        ...
        <?= Html::a('Submit', ['/admin/contest/status', 'id' => $model->id, 'active' => 1], ['class' => 'btn btn-danger']) ?>
        <?php Modal::end(); ?>

        <?= Html::a('Hide submission', ['/admin/contest/status', 'id' => $model->id, 'active' => 2], ['class' => 'btn btn-default']) ?>
        <?= Html::a(
            'Download all submissions',
            ['/admin/contest/download-solution', 'id' => $model->id],
            ['class' => 'btn btn-primary', 'data-toggle' => 'tooltip', 'data-placement' => 'top', 'title' => 'Download all correct submissions']
        ); ?>
        <?php Pjax::begin() ?>
        <?= Html::beginForm(
