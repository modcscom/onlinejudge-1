        ...
        <?php else: ?>
            <div class="contest-view">
                ...
                if ($model->scenario == $model::SCENARIO_OFFLINE && $model->getRunStatus() == $model::STATUS_RUNNING) {
                    $menuItems[] = [
                        'label' => '<span class="glyphicon glyphicon-print"></span> In',
...
<footer class="footer">
    <div class="container">
        <p>&copy; T36 Online Judge <?= date('Y') ?> - Power by <a href="https://facebook.com/vietthientran.301/">Greenhat1998</a></p>
    </div>
</footer>
<?php $this->endBody() ?>
<script>
