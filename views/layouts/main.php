...
<div class="wrap">
        ...
        <div class="container">
            <div class="page-header">
                <div class="logo pull-left">
                    ...
                    <div class="brand">
                        The People's Police University of Technology and Logictics
                    </div>
                </div>
    ...
    if (!Yii::$app->user->isGuest && Yii::$app->setting->get('mustVerifyEmail') && !Yii::$app->user->identity->isVerifyEmail()) {
        ...
        echo "<div class=\"container\"><p class=\"bg-danger\">Please go to the settings page to verify your email: {$a}</p></div>";
    }
    ?>
...
<footer class="footer">
    <div class="container">
        <p>&copy; <?= Yii::$app->setting->get('ojName') ?> <?= date('Y') ?> - Power by <a href="https://facebook.com/vietthientran.301/">Greenhat1998</a></p>
    </div>
</footer>
