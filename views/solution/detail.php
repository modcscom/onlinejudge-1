...
<div class="table-responsive">
    <table class="table table-bordered table-rank">
        <thead>
        <tr>
            <th width="70px">Run ID</th>
            <th width="120px"><?= Yii::t('app', 'Author') ?></th>
            <th width="150px"><?= Yii::t('app', 'Problem') ?></th>
            <th width="100px"><?= Yii::t('app', 'Lang') ?></th>
            <th width="120px"><?= Yii::t('app', 'Verdict') ?></th>
