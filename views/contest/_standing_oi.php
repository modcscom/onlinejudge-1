...
if (Yii::$app->user->isGuest || !Yii::$app->user->identity->isAdmin()) {
    if ($model->isScoreboardFrozen() || ($model->type == Contest::TYPE_OI && !$model->isContestEnd())) {
        echo '<p>Bảng xếp hạng sẽ được công bố sau khi cuộc thi kết thúc</p>';
        return;
    }
}
?>
<table class="table table-bordered table-rank" style="margin-top: 15px">
    ...
    <tr>
        ...
        <th width="120px">Total score</th>
        <th width="120px">Update score</th>
        <?php else: ?>
        <th width="80px">Answer</th>
        <th width="80px">Total score</th>
        <?php endif; ?>
        <th width="100px">
            Total time
            <span data-toggle="tooltip" data-placement="top" title="Chỉ tính tổng thời gian giải tất cả các bài trong cuộc thi">
            </span>
        </th>
