...
<div class="solution-index" style="margin-top: 20px">
    <?php if ($model->isScoreboardFrozen()) :?>
        <p class="text-center">Bảng xếp hạng hiện đã được đóng và sẽ không còn được cập nhật theo thời gian thực nữa. Bạn chỉ có thể xem kết quả bài nộp của bạn và các bài nộp trước khi đóng bảng xêpa hạng.</p>
    <?php endif; ?>
