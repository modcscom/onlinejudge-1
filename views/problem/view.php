...
<div class="row">
    ...
    <div class="col-md-3 problem-info">
        ...
        <?= Html::a('<span class="glyphicon glyphicon-arrow-left"></span>   Prev ',
        ...
        <?= Html::a(' Next   <span class="glyphicon glyphicon-arrow-right"></span>',
                    ...
                    <tr>
                        ...
                        <td>
                            <?= Html::a('<span class="glyphicon glyphicon-edit"></span>',
                                ['/solution/source', 'id' => $sub['id']],
                                ['title' => 'View source code', 'onclick' => 'return false', 'data-click' => "solution_info", 'data-pjax' => 0]) ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
